...
public class SourceLinesOfCodeProductRecursivePackageCalculator extends ElementCountPackageCalculator {

    public SourceLinesOfCodeProductRecursivePackageCalculator(Metric metric) {
        super(metric);
    }

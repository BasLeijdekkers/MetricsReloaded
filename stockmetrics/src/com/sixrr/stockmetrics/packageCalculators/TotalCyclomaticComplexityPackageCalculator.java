...
public class TotalCyclomaticComplexityPackageCalculator extends ElementCountPackageCalculator {

    public TotalCyclomaticComplexityPackageCalculator(Metric metric) {
        super(metric);
    }

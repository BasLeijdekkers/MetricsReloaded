...
public class LackOfCohesionInMethods2ClassMetric extends ClassMetric {
    ...
    public String getDisplayName() {
        return StockMetricsBundle.message("lack.of.cohesion.in.methods2.metric.display.name");
    }

    @NotNull
    @Override
    public String getAbbreviation() {
        return StockMetricsBundle.message("lack.of.cohesion.in.methods2.metric.abbreviation");
    }

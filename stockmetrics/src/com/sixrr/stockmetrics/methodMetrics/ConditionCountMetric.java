...
public class ConditionCountMetric extends MethodMetric {

    @NotNull
    @Override
    public String getDisplayName() {
        return StockMetricsBundle.message("condition.count.method.metric.display.name");
    }
    ...
    public MetricCalculator createCalculator() {
        return new ConditionCountCalculator();
    }
}
